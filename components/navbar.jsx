      ...
      <Container className='flex justify-between items-center'>
        ...
        <div className='flex'>
          <Link
            ...
            className='px-4 py-2 flex gap-1 text-sm sm:text-xl font-medium hover:font-bold'
          >
  ...
  <img className='w-8 h-8 object-cover' src="https://www.svgrepo.com/show/452221/google-maps.svg" alt="" />
        ...
        الحصول على الاتجاهات
          ...
          <Link
            ...
            className='px-4 flex gap-1 py-2 text-sm sm:text-xl font-medium hover:font-bold'
          >
